    ...
    EXEC('create view "dbo"."elementary_exposures__dbt_tmp_vw" as 
...
;');
        ...
        EXEC('CREATE TABLE [dw_gold].[dbo].[elementary_exposures] AS (SELECT * FROM [dw_gold].[dbo].[elementary_exposures__dbt_tmp_vw]);');
