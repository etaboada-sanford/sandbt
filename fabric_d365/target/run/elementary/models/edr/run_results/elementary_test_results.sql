    ...
    EXEC('create view "dbo"."elementary_test_results__dbt_tmp_vw" as 
...
;');
        ...
        EXEC('CREATE TABLE [dw_gold].[dbo].[elementary_test_results] AS (SELECT * FROM [dw_gold].[dbo].[elementary_test_results__dbt_tmp_vw]);');
