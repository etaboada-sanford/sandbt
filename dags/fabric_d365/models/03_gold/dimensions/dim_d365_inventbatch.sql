...
, ct1 as (
    ...
    select * from (
        select
            ...
            , rank() over (partition by upper(idh.inventbatchid), itemid order by ctdt.newzealandtime desc) as rnk
...
, cthist as (
    ...
    select
        ct1.*
        , case when ct.dxc_batchdispositiondetails_history = '' then null else dxc_batchdispositiondetails_history end as batchdispositiondetails_history
    from ct1
...
, ctfinal as (
    select
        ...
        , ctib.versionnumber
        , ctib.sysrowversion
        , case when ctib.proddate = '1900-01-01' then null else ctib.proddate end as proddate
        , case when ctib.pdsbestbeforedate = '1900-01-01' then null else ctib.pdsbestbeforedate end as pdsbestbeforedate
        , case when ctib.pdsfinishedgoodsdatetested = '1900-01-01' then null else ctib.pdsfinishedgoodsdatetested end as pdsfinishedgoodsdatetested
        , case when ctib.pdsshelfadvicedate = '1900-01-01' then null else ctib.pdsshelfadvicedate end as pdsshelfadvicedate
        , case when ctib.pdsvendbatchdate = '1900-01-01' then null else ctib.pdsvendbatchdate end as pdsvendbatchdate
        , case when ctib.pdsdispositioncode = '1900-01-01' then null else ctib.pdsdispositioncode end as pdsdispositioncode
        , case when ctib.productionstartdate = '1900-01-01' then null else ctib.productionstartdate end as productionstartdate
        , case when ctib.productionenddate = '1900-01-01' then null else ctib.productionenddate end as productionenddate
        , case when ctib.expdate = '1900-01-01' then null else ctib.expdate end as expdate
